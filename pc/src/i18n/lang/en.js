export default {
  ...
  ALREADY_LOGGIN:
    "Your account has already logged in another device, please logout first and try again later",
  ADD: "Add",
  REMOVE: "Remove",
  PRIORITY: "Priority",
  HIGH: "High",
  ...
  NEW_LOGIN_FROM: "Information about new login attempt:",
  DENY: "Deny",
  LOADING_MAP_ERROR: "Cannot load map information",
  ...
  EDIT_TEAM_MEMBER: "Edit team member(s)",
  DELETE_TEAM: "Delete this team",
  DELETE_TEAM_TITLE: "Delete team",
  DELETE_TEAM_MESSAGE: "Do you want to delete this team?",
  LEAVE_TEAM_TITLE: "Leave team",
  LEAVE_TEAM_MESSAGE: "Do you want to leave this team?",
